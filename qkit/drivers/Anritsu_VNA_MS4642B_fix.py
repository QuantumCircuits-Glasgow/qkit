...
class Anritsu_VNA_MS4642B(Instrument):
    ...
    def avg_status(self):
        return int(self._visainstrument.query(':SENS%i:AVER:SWE?' %(self._ci)))   
    ...
    def do_get_sweep_mode(self):
        return self._visainstrument.query(':SENS:HOLD:FUNC ?')
    ...
    def do_get_nop(self):
        ...
        if self._zerospan:
          ...
          if(self.get_cw()):
            self._nop = int(self._visainstrument.query(':SENS%i:SWE:CW:POIN?' %(self._ci)))
          else:
    ...
    def do_get_power(self):
        ...
        return float(self._visainstrument.query('SOUR%i:POW:PORT1:LEV:IMM:AMP?' % (self._ci)))
    ...
    def do_get_edel(self):   
        ...
        self._edel = float(self._visainstrument.query(":CALC1:PAR1:REF:EXT:TIM?"))
        return  self._edel   
    ...
    def do_get_cw(self):
        ...
        '''
        self._cw = bool(int(self._visainstrument.query(':SENS%i:SWE:CW?'%(self._ci))))
        return self._cw
    ...
    def do_get_source_attenuation(self,channel):
        ...
        return int(self._visainstrument.query('SOUR%i:POW:PORT%i:ATT?' %(self._ci,channel)))
    ...
    def do_get_source_power_start(self,channel):
        ...
        return float(self._visainstrument.query('SOUR%i:POW:PORT%i:LIN:POW:STAR?' %(self._ci,channel)))
    ...
    def do_get_source_power_stop(self,channel):
        ...
        return float(self._visainstrument.query('SOUR%i:POW:PORT%i:LIN:POW:STOP?' %(self._ci,channel)))
    ...
    def do_get_calibration_state(self):
        ...
        return bool(int(self._visainstrument.query('SENS%i:CORR:STAT?' %(self._ci))))
    ...
    def do_get_sweep_type(self):
        ...
        return str(self._visainstrument.query('SENS%i:SWE:TYP?' %(self._ci)))
    ...
    def do_get_power_nop(self,channel):
        ...
        return int(self._visainstrument.query(':SOUR%i:POW:PORT%i:LIN:POW:POIN?' %(self._ci,channel)))
    ...
    def do_get_avg_type(self):
        ...
        return str(self._visainstrument.query('SENS%i:AVER:TYP?' %(self._ci)))
